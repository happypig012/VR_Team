...
public class DialogSystem : MonoBehaviour
{
	...
	private void Setup()
	{
		...
		speakers[3].spriteRenderer.gameObject.SetActive(true);
    }
	...
	private void SetNextDialog()
	{
		...
		speakers[currentSpeakerIndex].isTalked = true; //해당 speaker는 말을 했다 표시
		// 다음 대사를 진행하도록 
		currentDialogIndex ++;
		...
		if(currentDialogIndex>=2 && currentSpeakerIndex!=3) //세종이 아닐 경우 이전의 금쪽이는 일러는 지워준다.
		{
...
public struct DialogData
{
    ...
    public AudioClip soundEffect; //대사 사운드
}
